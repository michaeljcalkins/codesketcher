...
angular
    ...
    .component('rulers', {
        controller: function (DrawingModel) {
            ...
            this.getXRulerWidth = () => {
                if (!_.has(DrawingModel, 'currentPage.styles.width')) return '2000px'

                return (parseInt(DrawingModel.currentPage.styles.width.slice(0, -2)) + 400) + 'px'
            }

            this.getYRulerHeight = () => {
                if (!_.has(DrawingModel, 'currentPage.styles.height')) return '2000px'

                return (parseInt(DrawingModel.currentPage.styles.height.slice(0, -2)) + 400) + 'px'
            }
        },
        template: `
