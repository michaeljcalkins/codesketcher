...
module.exports = function DrawingCanvasDirective(DrawingStorage) {
    return {
        ...
        controller: function controller($scope) {
            ...
            var createSquareByDragging = false;
...
// Directives
.directive('headerBar', require('./directives/headerBar.js')).directive('leftSidebar', require('./directives/leftSidebar.js')).directive('rightSidebar', require('./directives/rightSidebar.js')).directive('drawingCanvas', require('./directives/drawingCanvas.js'))
